 ...
 */
@Configuration
@MapperScan(basePackages = "org.xiaod.datatest.multi.dao.etrade.iface", sqlSessionFactoryRef = "etradeSqlSessionFactory")
public class EtradeDataSourceConfig {
    ...
    public SqlSessionFactory etradeSqlSessionFactory(@Qualifier("etradeDataSource") DataSource dataSource) throws Exception {
        ...
        Resource[] mapperLocations= new PathMatchingResourcePatternResolver().getResources("classpath:org/xiaod/datatest/multi/dao/etrade/xml/*.xml");
        bean.setMapperLocations(mapperLocations);
        return bean.getObject();
    }

    @Bean(name = "etradeTransactionManager")
    @Primary
    public DataSourceTransactionManager etradeTransactionManager(@Qualifier("etradeDataSource") DataSource dataSource){
