package org.xiaod.datatest.multi.test;//package org.xiaod.datatest.test;
//
...
//@ContextConfiguration({"classpath*:spring_config/spring-config.xml"})
//public class DataTransactionSpringTest {
//
//    @Autowired
